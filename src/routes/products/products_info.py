...
products_post.add_argument('product_name', type=str,
                           required=True, help='product name', location='json')
products_post.add_argument('product_type', type=str,
                           required=True, help='product type', location='json')
